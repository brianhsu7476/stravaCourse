...
\begin{multicols}{2}
\only<1-2>{
\item 檢舉他！檢舉完之後他就會從排行榜上消失了。\pause
\item 素材：\href{https://www.strava.com/athletes/117279779}{曹翊}
\newpage
\item \includegraphics[width=7cm]{flag0.png}
}\only<3->{
\pause\pause
\item 點選三個點（Actions）然後選擇 Flag ：\\\includegraphics[width=7cm]{flag1.png}\pause
\item 點選檢舉類型並輸入原因：\\\includegraphics[width=7cm]{flag2.png}\pause
}
\end{multicols}
\only<3->{
