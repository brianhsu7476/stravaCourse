...
\begin{frame}{單車人的 Instagram}
\begin{itemize}
\only<1-2>{
\begin{multicols}{2}
\item 加好友\\
\includegraphics[width=3cm]{friend.png}\\\pause
...
\begin{multicols}{2}
\item 加社團\\
\includegraphics[width=3cm]{club.png}\pause
\item 傳訊息\\
...
\only<1-3>{
\begin{itemize}
\item \includegraphics[width=5cm]{happen.png}
\pause
...
\begin{itemize}
\begin{multicols}{2}
\item \includegraphics[width=5cm]{forgetResume.jpeg}
\pause
\item \href{https://www.instagram.com/jonagraphs/reel/C-G-Cf_R5c6/}{When the run doesn't save.}
\item \includegraphics[width=5cm]{saveWhenCrash.jpg}
\end{multicols}
\end{itemize}
}\only<6->{
\pause\pause\pause\pause\pause
\begin{itemize}
\item \includegraphics[height=3.5cm]{smallTaiwan.jpg}\pause
...
\begin{multicols}{2}
\item 依照名稱尋找（僅限自己的活動）\\
\includegraphics[width=3cm]{getActivityByName.png}\pause
...
\includegraphics[width=3.2cm]{playActivityWuling.png}\pause
\includegraphics[width=3.2cm]{playActivityTaitung.png}\pause
