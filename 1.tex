...
\only<1-2>{
\begin{itemize}
\item \includegraphics[width=7cm]{happen.png}
\pause
\includegraphics[width=7cm]{giveBirth.png}
\end{itemize}
}\only<3>{
\begin{itemize}
\begin{multicols}{2}
...
\begin{itemize}
\item \includegraphics[height=3.5cm]{smallTaiwan.jpg}
\includegraphics[height=3.5cm]{china.jpg}
\includegraphics[height=3.5cm]{paw.jpg}
\includegraphics[height=3.5cm]{woman.png}\\
\includegraphics[height=3cm]{118.png}
\includegraphics[height=3cm]{batman.png}
\includegraphics[height=3cm]{cyclist.png}
